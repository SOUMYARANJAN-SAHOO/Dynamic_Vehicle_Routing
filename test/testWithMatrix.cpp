/*
This is a test of Dikstra's algorithm working with dummy dataset which is set with graph as a adjacency matrix
...
int main()
{
    ...
    cout << "The total time of execution is " << duration.count() << " microseconds";
